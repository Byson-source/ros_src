...
class OdomInfo(genpy.Message):
  _md5sum = "6eed65f48e7484f822a9994d9a28569e"
...
float32 y
float32 z"""
  __slots__ = ['header','lost','matches','inliers','icpInliersRatio','icpRotation','icpTranslation','icpStructuralComplexity','icpStructuralDistribution','icpCorrespondences','covariance','features','localMapSize','localScanMapSize','localKeyFrames','localBundleOutliers','localBundleConstraints','localBundleTime','keyFrameAdded','timeEstimation','timeParticleFiltering','stamp','interval','distanceTravelled','memoryUsage','gravityRollError','gravityPitchError','transform','transformFiltered','transformGroundTruth','guess','type','wordsKeys','wordsValues','wordMatches','wordInliers','localMapKeys','localMapValues','localScanMap','localScanMapFormat','refCorners','newCorners','cornerInliers']
  _slot_types = ['std_msgs/Header','bool','int32','int32','float32','float32','float32','float32','float32','int32','float64[36]','int32','int32','int32','int32','int32','int32','float32','bool','float32','float32','float32','float32','float32','int32','float32','float32','geometry_msgs/Transform','geometry_msgs/Transform','geometry_msgs/Transform','geometry_msgs/Transform','int32','int32[]','rtabmap_ros/KeyPoint[]','int32[]','int32[]','int32[]','rtabmap_ros/Point3f[]','uint8[]','int32','rtabmap_ros/Point2f[]','rtabmap_ros/Point2f[]','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.localScanMap is None:
        self.localScanMap = b''
      if self.localScanMapFormat is None:
        self.localScanMapFormat = 0
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.localScanMapFormat,) = _get_struct_i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.refCorners = []
