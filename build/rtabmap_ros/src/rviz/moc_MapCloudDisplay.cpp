...
QT_INIT_METAOBJECT const QMetaObject rtabmap_ros::MapCloudDisplay::staticMetaObject = { {
    &rviz::MessageFilterDisplay<rtabmap_ros::MapData>::staticMetaObject,
    qt_meta_stringdata_rtabmap_ros__MapCloudDisplay.data,
    qt_meta_data_rtabmap_ros__MapCloudDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
