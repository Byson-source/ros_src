...
"""autogenerated by genpy from cpp/LoopClosureActionResult.msg. Do not edit."""
import codecs
import sys
...
class LoopClosureActionResult(genpy.Message):
  _md5sum = "e5f62eb2cecdccdb33834c1bf0d40a1c"
  _type = "cpp/LoopClosureActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cpp/LoopClosureResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LoopClosureActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cpp.msg.LoopClosureResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cpp.msg.LoopClosureResult()
