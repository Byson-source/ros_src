...
class OdomInfo {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('localScanMapFormat')) {
        this.localScanMapFormat = initObj.localScanMapFormat
      }
      else {
        this.localScanMapFormat = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [localScanMapFormat]
    bufferOffset = _serializer.int32(obj.localScanMapFormat, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [localScanMapFormat]
    data.localScanMapFormat = _deserializer.int32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.localScanMapFormat !== undefined) {
      resolved.localScanMapFormat = msg.localScanMapFormat;
    }
    else {
      resolved.localScanMapFormat = 0
    }
