...
// (in-package service_practice.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'service_practice/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'service_practice/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'service_practice/AddTwoInts'; }
};
