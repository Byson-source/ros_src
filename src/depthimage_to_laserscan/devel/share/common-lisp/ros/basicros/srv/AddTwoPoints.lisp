...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoPoints-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoPoints-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name basicros-srv:<AddTwoPoints-request> is deprecated: use basicros-srv:AddTwoPoints-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <AddTwoPoints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader basicros-srv:a-val is deprecated.  Use basicros-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <AddTwoPoints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader basicros-srv:b-val is deprecated.  Use basicros-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AddTwoPoints-request>)))
  ...
  (cl:format cl:nil "#下はclientがserverにあげるやつ~%int64 a~%int64 b~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AddTwoPoints-request)))
  "Returns full string definition for message of type 'AddTwoPoints-request"
  (cl:format cl:nil "#下はclientがserverにあげるやつ~%int64 a~%int64 b~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoPoints-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoPoints-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name basicros-srv:<AddTwoPoints-response> is deprecated: use basicros-srv:AddTwoPoints-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <AddTwoPoints-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader basicros-srv:sum-val is deprecated.  Use basicros-srv:sum instead.")
  (sum m))
