...
class RtabmapReprocessFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RtabmapReprocessFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RtabmapReprocessFeedback(null);
...
module.exports = RtabmapReprocessFeedback;
