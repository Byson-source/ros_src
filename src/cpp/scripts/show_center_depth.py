...
class ImageListener:
    def __init__(self, depth_image_topic, depth_info_topic):
        ...
        self.sub_conf = rospy.Subscriber(
            confidence_topic, msg_Image, self.confidenceCallback)
...
def main():
    ...
    print('')
    print('Application subscribes to %s and %s topics.' %
    ...
    print('If a confedence map is also available in the topic %s, it also prints the confidence grade.' %
          depth_image_topic.replace('depth', 'confidence'))
    print('')
