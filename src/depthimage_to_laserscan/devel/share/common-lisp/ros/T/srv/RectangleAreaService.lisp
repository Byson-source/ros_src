...
(cl:defmethod cl:initialize-instance :after ((m <RectangleAreaService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RectangleAreaService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name T-srv:<RectangleAreaService-request> is deprecated: use T-srv:RectangleAreaService-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <RectangleAreaService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader T-srv:a-val is deprecated.  Use T-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <RectangleAreaService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader T-srv:b-val is deprecated.  Use T-srv:b instead.")
  (b m))
...
(cl:defmethod cl:initialize-instance :after ((m <RectangleAreaService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RectangleAreaService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name T-srv:<RectangleAreaService-response> is deprecated: use T-srv:RectangleAreaService-response instead.")))

(cl:ensure-generic-function 'area-val :lambda-list '(m))
(cl:defmethod area-val ((m <RectangleAreaService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader T-srv:area-val is deprecated.  Use T-srv:area instead.")
  (area m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RectangleAreaService-response>)))
  ...
  "T/RectangleAreaServiceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RectangleAreaService-response)))
  "Returns string type for a service object of type 'RectangleAreaService-response"
  "T/RectangleAreaServiceResponse")
