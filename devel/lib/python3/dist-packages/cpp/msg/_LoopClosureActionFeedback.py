...
"""autogenerated by genpy from cpp/LoopClosureActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class LoopClosureActionFeedback(genpy.Message):
  _md5sum = "d55bf109107cc4e4608c14ec0a33e345"
  _type = "cpp/LoopClosureActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cpp/LoopClosureFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LoopClosureActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cpp.msg.LoopClosureFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cpp.msg.LoopClosureFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.state,) = _get_struct_i().unpack(str[start:end])
      return self
