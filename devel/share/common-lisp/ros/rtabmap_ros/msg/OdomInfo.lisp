...
(cl:defclass <OdomInfo> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (localScanMapFormat
    :reader localScanMapFormat
    :initarg :localScanMapFormat
    :type cl:integer
    :initform 0)
   (refCorners
    :reader refCorners
...
(cl:defmethod guess-val ((m <OdomInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-msg:guess-val is deprecated.  Use rtabmap_ros-msg:guess instead.")
  (guess m))
...
(cl:ensure-generic-function 'localScanMapFormat-val :lambda-list '(m))
(cl:defmethod localScanMapFormat-val ((m <OdomInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-msg:localScanMapFormat-val is deprecated.  Use rtabmap_ros-msg:localScanMapFormat instead.")
  (localScanMapFormat m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <OdomInfo>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'localScanMapFormat)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <OdomInfo>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'localScanMap)))
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'localScanMapFormat) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<OdomInfo>)))
  ...
  "6eed65f48e7484f822a9994d9a28569e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'OdomInfo)))
  "Returns md5sum for a message object of type 'OdomInfo"
  "6eed65f48e7484f822a9994d9a28569e")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <OdomInfo>))
  ...
  (cl:list 'OdomInfo
    ...
    (cl:cons ':localScanMapFormat (localScanMapFormat msg))
