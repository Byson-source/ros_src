...
(cl:defmethod cl:initialize-instance :after ((m <AveragingFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AveragingFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cpp-msg:<AveragingFeedback> is deprecated: use cpp-msg:AveragingFeedback instead.")))

(cl:ensure-generic-function 'sample-val :lambda-list '(m))
(cl:defmethod sample-val ((m <AveragingFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cpp-msg:sample-val is deprecated.  Use cpp-msg:sample instead.")
  (sample m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <AveragingFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cpp-msg:data-val is deprecated.  Use cpp-msg:data instead.")
  (data m))

(cl:ensure-generic-function 'mean-val :lambda-list '(m))
(cl:defmethod mean-val ((m <AveragingFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cpp-msg:mean-val is deprecated.  Use cpp-msg:mean instead.")
  (mean m))

(cl:ensure-generic-function 'std_dev-val :lambda-list '(m))
(cl:defmethod std_dev-val ((m <AveragingFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cpp-msg:std_dev-val is deprecated.  Use cpp-msg:std_dev instead.")
  (std_dev m))
