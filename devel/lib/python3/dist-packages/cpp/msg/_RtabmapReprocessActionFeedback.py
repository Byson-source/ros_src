...
"""autogenerated by genpy from cpp/RtabmapReprocessActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class RtabmapReprocessActionFeedback(genpy.Message):
  _md5sum = "d55bf109107cc4e4608c14ec0a33e345"
  _type = "cpp/RtabmapReprocessActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cpp/RtabmapReprocessFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RtabmapReprocessActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cpp.msg.RtabmapReprocessFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cpp.msg.RtabmapReprocessFeedback()
