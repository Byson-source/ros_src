...
"""autogenerated by genpy from cpp/RtabmapReprocessActionResult.msg. Do not edit."""
import codecs
import sys
...
class RtabmapReprocessActionResult(genpy.Message):
  _md5sum = "3d669e3a63aa986c667ea7b0f46ce85e"
  _type = "cpp/RtabmapReprocessActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cpp/RtabmapReprocessResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RtabmapReprocessActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = cpp.msg.RtabmapReprocessResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = cpp.msg.RtabmapReprocessResult()
