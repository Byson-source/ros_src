...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetNodesInRadius-request>)))
  ...
  (cl:format cl:nil "#request~%~%# If target pose and node_id are all zeros, poses ~%# around the latest node in the graph are returned.~%# If node_id is not zero, target pose is ignored.~%~%# Node id~%int32 node_id~%~%# Target pose:~%float32 x~%float32 y~%float32 z~%~%# Radius, <=0 means that RGBD/LocalRadius will be used~%float32 radius~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetNodesInRadius-request)))
  "Returns full string definition for message of type 'GetNodesInRadius-request"
  (cl:format cl:nil "#request~%~%# If target pose and node_id are all zeros, poses ~%# around the latest node in the graph are returned.~%# If node_id is not zero, target pose is ignored.~%~%# Node id~%int32 node_id~%~%# Target pose:~%float32 x~%float32 y~%float32 z~%~%# Radius, <=0 means that RGBD/LocalRadius will be used~%float32 radius~%~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetNodesInRadius-response>)))
  ...
  (cl:format cl:nil "#response~%int32[] ids~%geometry_msgs/Pose[] poses~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetNodesInRadius-response)))
  "Returns full string definition for message of type 'GetNodesInRadius-response"
  (cl:format cl:nil "#response~%int32[] ids~%geometry_msgs/Pose[] poses~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
