...
"""autogenerated by genpy from cpp/LoopClosureAction.msg. Do not edit."""
import codecs
import sys
...
class LoopClosureAction(genpy.Message):
  _md5sum = "23a3ec43411f52f22f24c9ebec5792e4"
  _type = "cpp/LoopClosureAction"
...
"""
  ...
  _slot_types = ['cpp/LoopClosureActionGoal','cpp/LoopClosureActionResult','cpp/LoopClosureActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LoopClosureAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cpp.msg.LoopClosureActionGoal()
      if self.action_result is None:
        self.action_result = cpp.msg.LoopClosureActionResult()
      if self.action_feedback is None:
        self.action_feedback = cpp.msg.LoopClosureActionFeedback()
    else:
      self.action_goal = cpp.msg.LoopClosureActionGoal()
      self.action_result = cpp.msg.LoopClosureActionResult()
      self.action_feedback = cpp.msg.LoopClosureActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.imagepath
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.imagepath = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.imagepath = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (self.action_feedback.feedback.state,) = _get_struct_i().unpack(str[start:end])
      return self
