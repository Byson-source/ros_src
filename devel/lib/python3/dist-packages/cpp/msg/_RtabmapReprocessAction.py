...
"""autogenerated by genpy from cpp/RtabmapReprocessAction.msg. Do not edit."""
import codecs
import sys
...
class RtabmapReprocessAction(genpy.Message):
  _md5sum = "d5bd03af64ad5d14c3dd4dea6dd3c5b7"
  _type = "cpp/RtabmapReprocessAction"
...
"""
  ...
  _slot_types = ['cpp/RtabmapReprocessActionGoal','cpp/RtabmapReprocessActionResult','cpp/RtabmapReprocessActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RtabmapReprocessAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = cpp.msg.RtabmapReprocessActionGoal()
      if self.action_result is None:
        self.action_result = cpp.msg.RtabmapReprocessActionResult()
      if self.action_feedback is None:
        self.action_feedback = cpp.msg.RtabmapReprocessActionFeedback()
    else:
      self.action_goal = cpp.msg.RtabmapReprocessActionGoal()
      self.action_result = cpp.msg.RtabmapReprocessActionResult()
      self.action_feedback = cpp.msg.RtabmapReprocessActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.action_goal.goal.databasepaths)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.databasepaths:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.Struct('<I%ss'%length).pack(length, val1))
      _x = self.action_goal.goal.goal_path
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.databasepaths = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.databasepaths.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.goal_path = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.goal_path = str[start:end]
      _x = self
      start = end
      end += 12
